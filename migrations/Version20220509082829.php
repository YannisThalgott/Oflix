 ...
 */
final class Version20220509082829 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE casting (id INT AUTO_INCREMENT NOT NULL, role VARCHAR(50) NOT NULL, credit_order INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
